...
<div id="signup">
<h2 class="smp">CONFIRMATION MAIL<h2>
<center>
<font size="4px">

<label>To:</label>
<select id="to" name="to"  pattern="^[a-zA-Z0-9]+$" placeholder="To" type="text" required>

<label>Suject:</label><br>
<textarea placeholder="Subject" name="sub" required></textarea><br><br>
