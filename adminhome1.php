...
<body class="animsition">
    <div class="page-wrapper">
        <!-- HEADER MOBILE-->
        <header class="header-mobile d-block d-lg-none"><br><br>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="chart.html">
                                <i class="fas fa-chart-bar"></i>ADD VEHICLES</a>
                        </li>
                        <li>
                            <a href="table.html">
                        ...
                        <li>
                            <a href="#">
                                <i class="fas fa-calendar-alt"></i>SALES</a>
                        </li>
                        <li>
                            <a href="map.html">
        ...
        <!-- MENU SIDEBAR-->
        <aside class="menu-sidebar d-none d-lg-block"><br><br>
            <div class="logo">
                <a href="#">
                <img src="images/icon/logo2.jpg" alt="Cool Admin" />
                </a>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
						...
						<li>
                            <a href="table.php">
                                <i class="fas fa-chart-bar"></i>VIEW VEHICLES</a>
                        </li>
						<li>
                            <a href="viewcustomer.php">
                        ...
                        <li>
                            <a href="admin/profile-about.php">
                                <i class="fas fa-map-marker-alt"></i>MY PROFILE</a>
                        </li>
                                        ...
                                        <div class="chart-info">
                                            ...
                                            <div class="chart-info__right">
                                                ...
                                                <div class="chart-statis mr-0">
                                                    ...
                                                    <span class="label">services</span><br>
                                                </div><br><br>
                                                <div>
                                                    <img src="images/icon/5.jpg" alt="LOGOUT" />
                                                    </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-xl-6">
                                                <div class="chart-note-wrap">
                                                    ...
                                                    <div>
                                                    <img src="images/icon/images (3).jpg" alt="LOGOUT" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-xl-6">
                                                <div class="chart-note-wrap">
                                                    ...
                                                    <div>
                                                    <img src="images/icon/yamaha-bike-chidambaram-ho-chidambaram-motorcycle-dealers-yamaha-2tjmxzi.jpg" alt="LOGOUT" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
                                    ...
                                    <div class="au-card-inner">
                                        ...
                                        <div class="chart-info">
                                            ...
                                            <div class="chart-info__right">
                                                ...
                                                <div>
                                                    <img src="images/icon/123 (2).jpeg" alt="LOGOUT" />
                                                    </div>
                                            </div>
                                        </div>
