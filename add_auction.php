...
<?php
	...
	if(isset($_POST["Save"]))
	{
		...
		$suc =mysqli_query($conn, "update addvehicle set add_date='$add_date',bp=$bp,l_date='$l_date',brate=$brate where vid=$idd");// or die (mysqli_error());
...
<input id="bp" name="bp"  placeholder="Basic Price" type="text" required><br>
